...
void Start_run_user_application(void)
{
    ...
    GPIO_ConfigurePin( GPIO_PORT_2, GPIO_PIN_3, INPUT_PULLUP, PID_GPIO, 1 );
    GPIO_ConfigurePin( GPIO_PORT_2, GPIO_PIN_0, INPUT_PULLDOWN, PID_GPIO, 0 );
    GPIO_ConfigurePin( GPIO_PORT_2, GPIO_PIN_9, INPUT_PULLDOWN, PID_GPIO, 0 );
    GPIO_ConfigurePin( GPIO_PORT_2, GPIO_PIN_4, INPUT_PULLDOWN, PID_GPIO, 0 );
