...
static const struct advertise_configuration user_adv_conf = {
    ...
    .intv_min = 1600,//160,                    // 100ms (160*0.625ms)

    /// Maximum interval for advertising
    .intv_max = 1600,//160,                    // 100ms (160*0.625ms)
...
#define USER_DEVICE_NAME    ("GLO2")//("GLO-DEVICE-SUOTA-2")//("GLO-DEVICE-SUOTA-2")//("DIALOG-PRPH")
...
static const struct default_handlers_configuration  user_default_hnd_conf = {
    ...
    .security_request_scenario = DEF_SEC_REQ_ON_CONNECT//DEF_SEC_REQ_NEVER
};
