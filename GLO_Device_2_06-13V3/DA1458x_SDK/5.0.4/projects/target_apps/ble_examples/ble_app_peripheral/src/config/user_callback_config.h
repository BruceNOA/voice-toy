...
static const struct app_callbacks user_app_callbacks = {
    ...
    .app_on_adv_direct_complete     = user_app_adv_direct_complete,//NULL,
    .app_on_db_init_complete        = default_app_on_db_init_complete,
    .app_on_scanning_completed      = NULL,
    .app_on_adv_report_ind          = NULL,
#if (BLE_APP_SEC)
    .app_on_pairing_request         = default_app_on_pairing_request,//NULL,
    .app_on_tk_exch_nomitm          = default_app_on_tk_exch_nomitm,//NULL,
    .app_on_irk_exch                = NULL,
    .app_on_csrk_exch               = default_app_on_csrk_exch,//NULL,
    .app_on_ltk_exch                = default_app_on_ltk_exch,//NULL,
    .app_on_pairing_succeded        = NULL,
    .app_on_encrypt_ind             = NULL,
    .app_on_mitm_passcode_req       = NULL,
    .app_on_encrypt_req_ind         = default_app_on_encrypt_req_ind,//NULL,
